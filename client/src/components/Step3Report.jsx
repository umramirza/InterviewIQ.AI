...
function Step3Report({ report }) {
    ...
    if (finalScore >= 8) {
        ...
        performanceText = "Needs minor improvemnet before interviews.";
    ...
    const downloadPDF = () => {
        ...
        //--- Candidate Details Section (Added Labels) ---
        ...
        // Left Column
        doc.text(`Name: ${report.userName || "Candidate"}`, margin, currentY);
        doc.text(`Email: ${report.userEmail || "N/A"}`, margin, currentY + 7);
        
        // Right Column
        const rightCol = pageWidth / 2 + 10;
        doc.text(`Role: ${report.role || "N/A"}`, rightCol, currentY);
        doc.text(`Experience: ${report.experience || "N/A"}`, rightCol, currentY + 7);
        doc.text(`Date: ${new Date(report.createdAt).toLocaleDateString()}`, rightCol, currentY + 14);
        ...
        if (finalScore >= 8) {
            ...
            advice = "Good foundation shown. Improve clarity and strucure. Practice delivering concise, confident answers with stronger supporting examples."
        } else {
            advice = "Significant improvement required. Focus on structured thinking clarity, and confidence delivery. Practice answering aloud regularly."
        }
        ...
        doc.save(`Interview_Report_${report.userName || "Result"}.pdf`);
    };
